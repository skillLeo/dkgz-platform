...
class ContentBlockSeeder extends Seeder
{
    ...
    private function cityPages(): array
    {
        return [
            ...
            ['page_key' => 'staedte', 'section_key' => 'stadt', 'field_key' => 'cta', 'value' => 'Gutachter in {stadt} anfragen', 'label_de' => 'Stadtseite · Schaltfläche'],
            ...
            ['page_key' => 'staedte', 'section_key' => 'leistung', 'field_key' => 'ueberschrift', 'value' => '{leistung} in {stadt}', 'label_de' => 'Leistungsseite · Überschrift (H1)', 'help_de' => '{leistung} und {stadt} werden ersetzt.'],
            ['page_key' => 'staedte', 'section_key' => 'leistung', 'field_key' => 'einleitung', 'type' => 'richtext', 'value' => 'Sie benötigen ein {leistung} in {stadt}? Wir vermitteln Ihnen einen geprüften Kfz-Sachverständigen aus der Region — in der Regel noch am selben Werktag.', 'label_de' => 'Leistungsseite · Einleitung', 'help_de' => 'Gilt für Städte ohne eigenen Einleitungstext.'],
            ['page_key' => 'staedte', 'section_key' => 'leistung', 'field_key' => 'cta', 'value' => 'Gutachter in {stadt} anfragen', 'label_de' => 'Leistungsseite · Schaltfläche'],
            ['page_key' => 'staedte', 'section_key' => 'leistung', 'field_key' => 'ablauf_ueberschrift', 'value' => 'So kommen Sie zum {leistung} in {stadt}', 'label_de' => 'Leistungsseite · Überschrift Ablauf'],
            ...
            ['page_key' => 'staedte', 'section_key' => 'leistung', 'field_key' => 'schritt_3', 'type' => 'richtext', 'value' => 'Der erste verfügbare Sachverständige übernimmt das {leistung} und meldet sich direkt bei Ihnen.', 'label_de' => 'Leistungsseite · Schritt 3'],
            ['page_key' => 'staedte', 'section_key' => 'leistung', 'field_key' => 'weitere_leistungen', 'value' => 'Weitere Gutachten in {stadt}', 'label_de' => 'Leistungsseite · Überschrift weitere Leistungen'],
            ['page_key' => 'staedte', 'section_key' => 'leistung', 'field_key' => 'weitere_staedte', 'value' => '{leistung} in anderen Städten', 'label_de' => 'Leistungsseite · Überschrift andere Städte'],
