...
class ContentBlockSeeder extends Seeder
{
    ...
    private function homepage(): array
    {
        return [
            ...
            ['page_key' => 'startseite', 'section_key' => 'hero', 'field_key' => 'eyebrow_anzeigen', 'type' => 'boolean', 'value' => '1', 'label_de' => 'Hero · Übertitel anzeigen', 'help_de' => 'Schaltet die Zeile über der Überschrift samt goldenem Strich ein und aus. Der Text bleibt erhalten.'],
            ['page_key' => 'startseite', 'section_key' => 'hero', 'field_key' => 'eyebrow', 'value' => 'Deutsche Kfz-Gutachterzentrale', 'label_de' => 'Hero · Übertitel', 'help_de' => 'Erscheint über der Überschrift. Zum Ausblenden den Schalter »Hero · Übertitel anzeigen« verwenden — der Text bleibt dabei erhalten.'],
            ...
            ['page_key' => 'startseite', 'section_key' => 'hero', 'field_key' => 'option_weitere', 'value' => 'Weitere Gutachten', 'label_de' => 'Hero · Zweite Auswahl', 'help_de' => 'Die erste Auswahl trägt den Namen der Leistung, die unter Leistungsarten ganz oben steht.'],
            ['page_key' => 'startseite', 'section_key' => 'hero', 'field_key' => 'bild_mobil', 'type' => 'boolean', 'value' => '0', 'label_de' => 'Hero · Bild auch auf dem Handy zeigen', 'help_de' => 'Aus: das Bild erscheint nur ab Tablet-Breite. Ein: es erscheint auf dem Handy zusätzlich klein unter dem Anfragefeld.'],
            ['page_key' => 'startseite', 'section_key' => 'hero', 'field_key' => 'bewertung_text', 'value' => 'Von Kunden aus ganz Deutschland empfohlen', 'label_de' => 'Hero · Zeile neben den Kundenfotos', 'help_de' => 'Die Fotos und die Sterne stammen aus den veröffentlichten Kundenstimmen. Ohne veröffentlichte Stimmen erscheint der Bereich nicht.'],
    ...
    private function requestPage(): array
    {
        return [
            ...
            // The footer stands on every page, so its wording belongs to the
            // shell and not to the homepage. Kept under "startseite" it was read
            // from whichever page's content happened to be loaded, so editing it
            // changed the homepage and left the other twenty pages showing the
            // wording built into the template.
            ['page_key' => 'layout', 'section_key' => 'fuss', 'field_key' => 'beschreibung', 'value' => 'Bundesweite Vermittlung von Kfz-Sachverständigen. Eine Anfrage, ein Ansprechpartner, geprüfte Partner in allen PLZ-Gebieten.', 'label_de' => 'Fußbereich · Beschreibung', 'help_de' => 'Steht im Fußbereich jeder Seite.'],
            ['page_key' => 'layout', 'section_key' => 'fuss', 'field_key' => 'rechtshinweis', 'value' => 'DKGZ ist eine Vermittlungsstelle. Das Gutachten erstellt der vermittelte Sachverständige.', 'label_de' => 'Fußbereich · Rechtshinweis', 'help_de' => 'Steht unten rechts im Fußbereich jeder Seite.'],

            ['page_key' => 'anfrage', 'section_key' => 'kopf', 'field_key' => 'eyebrow_anzeigen', 'type' => 'boolean', 'value' => '1', 'label_de' => 'Schritt 1 · Übertitel anzeigen', 'help_de' => 'Schaltet die Zeile über der Überschrift samt goldenem Strich ein und aus. Der Text bleibt erhalten.'],
            ['page_key' => 'anfrage', 'section_key' => 'kopf', 'field_key' => 'eyebrow', 'value' => 'Kostenlose Anfrage', 'label_de' => 'Schritt 1 · Übertitel'],
            ['page_key' => 'anfrage', 'section_key' => 'formular', 'field_key' => 'frage_leistung', 'value' => 'Welches Gutachten benötigen Sie?', 'label_de' => 'Schritt 1 · Überschrift'],
            ['page_key' => 'anfrage', 'section_key' => 'formular', 'field_key' => 'frage_hinweis', 'value' => 'Wählen Sie die passende Leistung aus. Über das i erfahren Sie, wofür ein Gutachten gedacht ist.', 'label_de' => 'Schritt 1 · Text unter der Überschrift'],
            ['page_key' => 'anfrage', 'section_key' => 'formular', 'field_key' => 'weiter', 'value' => 'Weiter', 'label_de' => 'Schritt 1 · Schaltfläche unter der Auswahl', 'help_de' => 'Wird erst aktiv, sobald eine Leistung gewählt ist.'],
            ['page_key' => 'anfrage', 'section_key' => 'formular', 'field_key' => 'info', 'value' => 'Was ist das?', 'label_de' => 'Schritt 1 · Beschriftung der Info-Schaltfläche', 'help_de' => 'Nur für Screenreader. Sichtbar ist nur das i.'],
            ['page_key' => 'anfrage', 'section_key' => 'formular', 'field_key' => 'gewaehlte_leistung', 'value' => 'Gutachten', 'label_de' => 'Schritt 2 · Wort vor der gewählten Leistung', 'help_de' => 'Steht über dem weißen Kasten vor dem Namen der gewählten Leistung. Der Doppelpunkt wird automatisch angehängt.'],
            ['page_key' => 'anfrage', 'section_key' => 'formular', 'field_key' => 'verfuegbarkeit_anzeigen', 'type' => 'boolean', 'value' => '1', 'label_de' => 'Schritt 2 · Verfügbarkeitszeile anzeigen', 'help_de' => 'Die Zeile mit dem grünen Haken unter der gewählten Leistung.'],
            ['page_key' => 'anfrage', 'section_key' => 'formular', 'field_key' => 'verfuegbarkeit', 'type' => 'richtext', 'value' => 'Passende Kfz-Gutachter für {Ihren leistung} sind deutschlandweit verfügbar.', 'label_de' => 'Schritt 2 · Verfügbarkeitszeile', 'help_de' => '{Ihren leistung} wird zur gewählten Gutachtenart — „Ihr Unfallgutachten“, „Ihre Fahrzeugbewertung“. Das Wort davor gehört mit in die Klammer, sonst passt es nicht zu jeder Leistung. Die Zeile erscheint, bevor die Postleitzahl bekannt ist — bitte nur zusagen, was bundesweit stimmt.'],
            ...
            ['page_key' => 'anfrage', 'section_key' => 'formular', 'field_key' => 'platzhalter_plz', 'value' => '40210', 'label_de' => 'Schritt 2 · Platzhalter im PLZ-Feld'],
            ['page_key' => 'anfrage', 'section_key' => 'formular', 'field_key' => 'platzhalter_name', 'value' => 'Vor- und Nachname', 'label_de' => 'Schritt 2 · Platzhalter im Namensfeld'],
            ['page_key' => 'anfrage', 'section_key' => 'formular', 'field_key' => 'platzhalter_telefon', 'value' => 'Telefonnummer eingeben', 'label_de' => 'Schritt 2 · Platzhalter im Telefonfeld'],
            ['page_key' => 'anfrage', 'section_key' => 'formular', 'field_key' => 'hinweis_telefon', 'value' => 'Für die direkte Kontaktaufnahme durch den Sachverständigen.', 'label_de' => 'Schritt 2 · Hinweis unter dem Telefonfeld', 'help_de' => 'Leer lassen, um die Zeile wegzulassen.'],
            ['page_key' => 'anfrage', 'section_key' => 'formular', 'field_key' => 'telefon_zuerst', 'type' => 'boolean', 'value' => '1', 'label_de' => 'Schritt 2 · Telefonnummer vor E-Mail-Adresse', 'help_de' => 'Aus: die E-Mail-Adresse wird zuerst abgefragt. Beide Felder bleiben Pflichtfelder.'],
            ['page_key' => 'anfrage', 'section_key' => 'formular', 'field_key' => 'platzhalter_email','value' => 'E-Mail eingeben', 'label_de' => 'Schritt 2 · Platzhalter im E-Mail-Feld'],
            ...
            ['page_key' => 'anfrage', 'section_key' => 'formular', 'field_key' => 'rueckmeldung', 'value' => 'Ein Sachverständiger aus {stadt} meldet sich in der Regel innerhalb weniger Minuten telefonisch bei Ihnen.', 'label_de' => 'Schritt 2 · Hinweis zur Rückmeldung', 'help_de' => '{stadt} und {plz} werden ersetzt. Erscheint über der Schaltfläche, sobald die Postleitzahl erkannt ist. Leer lassen, um ihn wegzulassen.'],
    ...
    private function cityPages(): array
    {
        return [
            ...
            ['page_key' => 'staedte', 'section_key' => 'stadt', 'field_key' => 'bild', 'type' => 'image', 'value' => '', 'label_de' => 'Stadtseite · Standardbild neben der Überschrift', 'help_de' => 'Erscheint auf jeder Stadtseite, die kein eigenes Bild hat. Ein eigenes Bild je Stadt hinterlegen Sie unter Städte. Ohne Standardbild wird das Bild der Startseite gezeigt. Ob es auf dem Handy erscheint, richtet sich nach der Startseite.'],
            ['page_key' => 'staedte', 'section_key' => 'stadt', 'field_key' => 'bild_groesse', 'value' => '', 'label_de' => 'Stadtseite · Bildgröße in Prozent', 'help_de' => 'Zwischen 60 und 140. Gilt für das Standardbild und für jede Stadt, deren eigenes Bild keine eigene Größe hat. Leer: wie auf der Startseite.'],
            ...
            ['page_key' => 'startseite', 'section_key' => 'kopf', 'field_key' => 'meta_titel', 'value' => 'Kfz-Gutachter finden — bundesweit vermittelt | DKGZ', 'label_de' => 'Seitentitel für Google'],
            ['page_key' => 'startseite', 'section_key' => 'kopf', 'field_key' => 'meta_text', 'type' => 'richtext', 'value' => 'Sie brauchen einen Kfz-Sachverständigen? DKGZ vermittelt Ihnen bundesweit einen geprüften Gutachter in Ihrer Region. Kostenfrei und unverbindlich.', 'label_de' => 'Beschreibung für Google'],
            ['page_key' => 'ablauf', 'section_key' => 'kopf', 'field_key' => 'meta_titel', 'value' => 'So funktioniert die Vermittlung | DKGZ', 'label_de' => 'Seitentitel für Google'],
            ['page_key' => 'ablauf', 'section_key' => 'kopf', 'field_key' => 'meta_text', 'type' => 'richtext', 'value' => 'Von der Anfrage bis zum fertigen Gutachten: wie DKGZ Ihnen einen Kfz-Sachverständigen vermittelt — ohne Angebotsvergleich und ohne Kundenkonto.', 'label_de' => 'Beschreibung für Google'],
            ['page_key' => 'ueber-uns', 'section_key' => 'kopf', 'field_key' => 'meta_titel', 'value' => 'Über die Deutsche KFZ-Gutachterzentrale | DKGZ', 'label_de' => 'Seitentitel für Google'],
            ['page_key' => 'ueber-uns', 'section_key' => 'kopf', 'field_key' => 'meta_text', 'type' => 'richtext', 'value' => 'DKGZ ist eine bundesweite Vermittlungsstelle für Kfz-Sachverständige. Kein Vergleichsportal, kein eigener Gutachter, für Anfragende kostenfrei.', 'label_de' => 'Beschreibung für Google'],
            ['page_key' => 'kontakt', 'section_key' => 'kopf', 'field_key' => 'meta_titel', 'value' => 'Kontakt zur Deutschen KFZ-Gutachterzentrale | DKGZ', 'label_de' => 'Seitentitel für Google'],
            ['page_key' => 'kontakt', 'section_key' => 'kopf', 'field_key' => 'meta_text', 'type' => 'richtext', 'value' => 'Fragen zu einer laufenden Anfrage oder zur Vermittlung? So erreichen Sie die Deutsche KFZ-Gutachterzentrale.', 'label_de' => 'Beschreibung für Google'],
            ['page_key' => 'partner', 'section_key' => 'kopf', 'field_key' => 'meta_titel', 'value' => 'Als Kfz-Sachverständiger Partner werden | DKGZ', 'label_de' => 'Seitentitel für Google'],
            ['page_key' => 'partner', 'section_key' => 'kopf', 'field_key' => 'meta_text', 'type' => 'richtext', 'value' => 'Aufträge aus Ihrer Region ohne Akquise. Sie legen Einsatzgebiet und Leistungen fest, DKGZ leitet passende Anfragen weiter.', 'label_de' => 'Beschreibung für Google'],
            ['page_key' => 'anfrage', 'section_key' => 'kopf', 'field_key' => 'meta_titel', 'value' => 'Kfz-Gutachter anfragen — kostenfrei | DKGZ', 'label_de' => 'Seitentitel für Google'],
            ['page_key' => 'anfrage', 'section_key' => 'kopf', 'field_key' => 'meta_text', 'type' => 'richtext', 'value' => 'In zwei Schritten zum passenden Kfz-Sachverständigen. Die Anfrage ist kostenfrei und unverbindlich, eine Registrierung ist nicht nötig.', 'label_de' => 'Beschreibung für Google'],
            ...
            ['page_key' => 'verzeichnis', 'section_key' => 'profil', 'field_key' => 'beschreibung', 'type' => 'richtext', 'value' => '{name} ist als Kfz-Sachverständiger in {stadt} und Umgebung tätig und bietet verschiedene Gutachterleistungen an. Dazu zählen unter anderem {leistungen}. Über DKGZ können Sie direkt eine Anfrage für die passende Begutachtung an {name} senden und die weiteren Schritte persönlich abstimmen.', 'label_de' => 'Profil · Beschreibung unter dem Namen', 'help_de' => '{name}, {stadt} und {leistungen} werden je Sachverständigem eingesetzt. Gilt für alle Profile.'],
            ['page_key' => 'verzeichnis', 'section_key' => 'profil', 'field_key' => 'cta_mobil', 'value' => 'Jetzt Gutachter kontaktieren', 'label_de' => 'Profil · Schaltfläche auf dem Handy', 'help_de' => 'Erscheint nur auf schmalen Bildschirmen und springt zum Anfrageformular.'],
            ['page_key' => 'verzeichnis', 'section_key' => 'profil', 'field_key' => 'beschreibung_ohne_leistungen', 'type' => 'richtext', 'value' => '{name} ist als Kfz-Sachverständiger in {stadt} und Umgebung tätig. Über DKGZ können Sie direkt eine Anfrage für die passende Begutachtung an {name} senden und die weiteren Schritte persönlich abstimmen.', 'label_de' => 'Profil · Vorstellung ohne Leistungen', 'help_de' => 'Wird verwendet, solange für diesen Partner keine Leistungen hinterlegt sind. {leistungen} steht hier nicht zur Verfügung.'],
            ['page_key' => 'verzeichnis', 'section_key' => 'profil', 'field_key' => 'meta_text', 'type' => 'richtext', 'value' => '{name} — geprüfter Kfz-Sachverständiger in {stadt}. Gutachten nach Unfall, Schaden oder für die Fahrzeugbewertung. Anfrage über DKGZ, kostenfrei und unverbindlich.', 'label_de' => 'Profil · Beschreibung für Google', 'help_de' => '{name}, {stadt} und {leistungen} werden eingesetzt. Gilt für alle Profilseiten.'],
            ...
            ['page_key' => 'verzeichnis', 'section_key' => 'profil', 'field_key' => 'pausiert_titel', 'value' => 'Nimmt derzeit keine Anfragen an', 'label_de' => 'Profil · Überschrift, wenn der Partner nicht erreichbar ist', 'help_de' => 'Erscheint statt des Formulars nur, wenn eine Anfrage diesen Sachverständigen gar nicht erreichen könnte — etwa weil sein Haftpflichtnachweis abgelaufen ist. Wer sich im Portal nur als nicht verfügbar markiert hat, bekommt Direktanfragen weiterhin.'],
            ['page_key' => 'verzeichnis', 'section_key' => 'profil', 'field_key' => 'pausiert_text', 'type' => 'richtext', 'value' => 'Dieser Sachverständige ist zurzeit nicht verfügbar. Stellen Sie Ihre Anfrage über DKGZ — wir vermitteln Sie an einen passenden Sachverständigen in Ihrer Region.', 'label_de' => 'Profil · Text, wenn der Partner pausiert'],
            ['page_key' => 'verzeichnis', 'section_key' => 'profil', 'field_key' => 'pausiert_cta', 'value' => 'Anfrage über DKGZ stellen', 'label_de' => 'Profil · Schaltfläche, wenn der Partner pausiert'],
            ...
            ['page_key' => 'verzeichnis', 'section_key' => 'profil', 'field_key' => 'kurzhinweis', 'value' => 'Kostenfrei und unverbindlich', 'label_de' => 'Profil · Zusicherung mit Häkchen', 'help_de' => 'Leer lassen, um die Zeile wegzulassen.'],
            ...
            ['page_key' => 'staedte', 'section_key' => 'leistung', 'field_key' => 'bild', 'type' => 'image', 'value' => '', 'label_de' => 'Leistungsseite · Standardbild neben der Überschrift', 'help_de' => 'Die Seite zeigt zuerst das Bild der Leistung (unter Leistungsarten), sonst das Bild der Stadt (unter Städte), sonst dieses Standardbild und ohne Standardbild das Bild der Startseite.'],
            ['page_key' => 'staedte', 'section_key' => 'leistung', 'field_key' => 'bild_groesse', 'value' => '', 'label_de' => 'Leistungsseite · Bildgröße in Prozent', 'help_de' => 'Zwischen 60 und 140. Gilt für das Standardbild und für ein Bild der Leistung oder der Stadt, das keine eigene Größe hat. Leer: wie auf der Startseite.'],
    ...
    private function servicesPage(): array
    {
        return [
            ...
            ['page_key' => 'leistungen', 'section_key' => 'detail', 'field_key' => 'bild', 'type' => 'image', 'value' => '', 'label_de' => 'Detailseite — Standardbild neben der Überschrift', 'help_de' => 'Erscheint auf jeder Leistungsseite, die kein eigenes Bild hat. Ein eigenes Bild je Leistung hinterlegen Sie unter Leistungsarten. Ohne Standardbild wird das Bild der Startseite gezeigt. Ob es auf dem Handy erscheint, richtet sich nach der Startseite.'],
            ['page_key' => 'leistungen', 'section_key' => 'detail', 'field_key' => 'bild_groesse', 'value' => '', 'label_de' => 'Detailseite — Bildgröße in Prozent', 'help_de' => 'Zwischen 60 und 140. Gilt für das Standardbild und für jede Leistung, deren eigenes Bild keine eigene Größe hat. Leer: wie auf der Startseite.'],
