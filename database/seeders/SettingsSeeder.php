...
class SettingsSeeder extends Seeder
{
    ...
    private function definitions(): array
    {
        ...
        return array_merge($branding, [
            ...
            ['group' => 'business', 'key' => 'business.google_review_url', 'type' => 'string', 'value' => 'https://g.page/r/CVmwdYwMPeyhECE/review', 'label_de' => 'Google-Bewertungslink', 'help_de' => 'Der Link aus Ihrem Google-Unternehmensprofil. Leer lassen, um die Bewertungsmail nicht zu versenden.'],
            ['group' => 'business', 'key' => 'business.google_review_delay_days', 'type' => 'integer', 'value' => '1', 'label_de' => 'Bewertungsmail nach (Tage)', 'help_de' => 'Tage nach der Annahme durch den Sachverständigen, bevor der Kunde um eine Google-Bewertung gebeten wird.'],
            ...
            ['group' => 'features', 'key' => 'features.internal_review_request', 'type' => 'boolean', 'value' => '0', 'label_de' => 'Interne Bewertungsanfrage versenden', 'help_de' => 'Zusätzlich zur Google-Bewertung nach Abschluss die eigene Bewertungsskala abfragen. Standardmäßig aus, damit ein Kunde nicht zweimal gefragt wird.'],
