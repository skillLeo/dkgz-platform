...
<template>
    ...
    <PublicLayout>
        <div class="mx-auto w-full max-w-(--container-shell) px-4 py-20 md:px-6">
            ...
            <h1 class="pt-6 text-h1 font-bold text-navy-700">Welches Gutachten benötigen Sie?</h1>
            <p class="measure-lead pt-4 text-lead leading-relaxed text-gray-600">
                Wir vermitteln für jede dieser Leistungen einen geprüften Sachverständigen aus Ihrer Region.
                Die Anfrage ist in jedem Fall kostenfrei.
            </p>
            ...
            <div class="grid grid-cols-1 gap-4 pt-12 sm:grid-cols-2 lg:grid-cols-3">
                ...
                >
                    ...
                    <span class="pt-5 text-base font-medium text-navy-700">Gutachter finden →</span>
                </Link>
            </div>

            <div class="mt-16 border border-navy-700 p-8">
                <h2 class="text-h2 font-semibold text-navy-700">Nicht sicher, was Sie brauchen?</h2>
                <p class="measure pt-3 text-base leading-normal text-gray-600">
                    Beschreiben Sie in der Anfrage kurz, was passiert ist. Der vermittelte Sachverständige ordnet den
                    Fall ein und sagt Ihnen, welches Gutachten in Ihrem Fall das richtige ist.
                </p>
