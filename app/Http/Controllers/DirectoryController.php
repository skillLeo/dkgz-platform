    ...
    public function show(Assessor $assessor): Response
    {
        ...
        return Inertia::render('Public/Sachverstaendiger', [
            ...
            'assessor' => array_merge($this->card($assessor), [
                ...
                // Whether a request aimed here could actually arrive. Not the
                // same question as whether this partner is taking work today: a
                // partner who has paused still hears from somebody who chose
                // them by name. Only a lapsed cover or a closed account keeps
                // the form from being offered, because then nothing sent
                // through it could reach anybody.
                'accepting' => $assessor->acceptsDirectRequests(),
            ]),
