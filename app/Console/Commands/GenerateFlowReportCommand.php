...
class GenerateFlowReportCommand extends Command
{
    ...
    private const RECIPIENTS = [
        ...
        'google-bewertung' => ['Kunde', 'Einen Tag nach der Annahme durch den Sachverständigen'],
        'bewertungsanfrage' => ['Kunde', 'Nach der eingestellten Frist ab Abschluss, sofern die interne Bewertung aktiv ist'],
